...
initState_0 = complex( fi( [ 0.772790905621241; 0.631669339981830 ], nt1, fm ), fi( [ 0.052860346093275; 0.031525306135226 ], nt1, fm ) );
initState_0_bin = bin( initState_0 );
initState_1 = complex( fi( [ 0.772790905621241; 0.631669339981830 ], nt1, fm ), fi( [ 0.052860346093275; 0.031525306135226 ], nt1, fm ) );
...
[computerState_my,probFinal_my,probQubit_0_my,probQubit_1_my] = quantumComputer_twoQubit_wrapper_fixpt_cosim( opName_0, theta_0, phi_0, lambda_0, opName_1, theta_1, phi_1, lambda_1, initState_0, initState_1 );
